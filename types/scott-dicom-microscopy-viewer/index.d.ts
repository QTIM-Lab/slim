declare module 'scott-dicom-microscopy-viewer' {
    ...
    declare namespace viewer {
      ...
      export class VolumeImageViewer {
        ...
        someFunction (): void
        setImageAugmentationHue (inputValue: number): void
        setImageAugmentationBrightness (inputValue: number): void
        setImageAugmentationSaturation (inputValue: number): void
        setImageAugmentationContrast (inputValue: number): void
        setImageAugmentationSharpen (inputValue: number): void
        setImageAugmentationDetectEdges (inputValue: boolean): void
        setImageAugmentationNegative (inputValue: boolean): void
